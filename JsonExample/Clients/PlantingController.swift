...
let sharedPlantingInstance = PlantingController()

class PlantingController: NSObject{
    var session = URLSession.shared
    var dataStr = ""
    
    class var Plantinginstance: JsonClient{
        return sharedInstance
    }
    
    public func getRequest(url: String, completionHandler: @escaping(String,[Planting], Error?) -> Void ){
        var model = [Planting]()
        ...
        let task = session.dataTask(with: request){ (data, resp, error ) in
            ...
            do{
                ...
                model = try decoder.decode([Planting].self, from: dataResponse)
    ...
    public func getByIdRequest(url: String, id: String, completionHandler: @escaping(Planting, Error?) -> Void ){
        var model: Planting?
