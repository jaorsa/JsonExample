...
let sharedZoneInstance = ZoneController()

class ZoneController: NSObject{
    var session = URLSession.shared
    var dataStr = ""
    
    class var Zoneinstance: JsonClient{
        return sharedInstance
    }
    
    public func getRequest(url: String, completionHandler: @escaping(String,[Zone], Error?) -> Void ){
        var model = [Zone]()
        ...
        let task = session.dataTask(with: request){ (data, resp, error ) in
            ...
            do{
                ...
                model = try decoder.decode([Zone].self, from: dataResponse)
    ...
    public func getByIdRequest(url: String, id: String, completionHandler: @escaping(Zone, Error?) -> Void ){
        var model: Zone?
