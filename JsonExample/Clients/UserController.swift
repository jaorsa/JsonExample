...
let sharedUserInstance = UserController()

class UserController: NSObject{
    var session = URLSession.shared
    var dataStr = ""
    
    class var Userinstance: JsonClient{
        return sharedInstance
    }
    
    public func getRequest(url: String, completionHandler: @escaping(String,[Users], Error?) -> Void ){
        var model = [Users]()
    ...
    public func putRequest(url: String, id: String, name: String, correo: String, equipo: Int){
