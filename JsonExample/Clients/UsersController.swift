...
let sharedUsersInstance = UsersController()

class UsersController: NSObject{
    var session = URLSession.shared
    var dataStr = ""
    
    class var Usersinstance: JsonClient{
        return sharedInstance
    }
    
    public func getRequest(url: String, completionHandler: @escaping(Bool,[Users], Error?) -> Void ){
        var model = [Users]()
